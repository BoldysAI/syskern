            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        validators=[
                            django.core.validators.MinValueValidator(0),
                            django.core.validators.MaxValueValidator("0.9999"),
                        ],
                    ),
                ),
                (
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("simulation", "product"), name="unique_product_per_simulation"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("manual_current_params", "Manual — current params"),
                            ("manual_refresh_odoo", "Manual — refresh Odoo"),
                            ("manual_full_refresh", "Manual — full refresh"),
                            ("line_recalculate", "Single-line recalc"),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["simulation", "-calculated_at"], name="idx_recalc_simulation_date"
                    )
                ],
            },
        ),
