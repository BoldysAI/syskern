    ...
    <div className="flex h-full">
      ...
      <aside className="hidden lg:flex flex-col w-64 flex-shrink-0 bg-white border-r border-[#E2E8F0] overflow-y-auto">
        <div className="p-4 border-b border-[#E2E8F0]">
          <div className="flex items-center justify-between mb-1">
            ...
            {(selectedUniverses.length > 0 || search) && (
              <button
                ...
                onClick={() => { setSelectedUniverses([]); setSearch(""); setPage(1); }}
              >
                Réinitialiser
              </button>
            )}
          ...
          {total > 0 && (
            <span className="text-xs text-slate-400">{total} produit{total > 1 ? "s" : ""}</span>
          )}
        </div>
                ...
                <tr>
                  {(
                    [
                      ...
                      { key: "supplier", label: "Fournisseur actif", noSort: true },
                ...
                {isLoading
                  ...
                  : sortedProducts.map((product) => {
                      ...
                      <tr
                        ...
                        onClick={() => router.push(`/catalog/${encodeURIComponent(product.sku_code)}`)}
                      >
