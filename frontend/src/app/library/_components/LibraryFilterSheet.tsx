...
import { countActiveLibraryFilters, type LibraryFilters } from "./library-filters";
...
export function LibraryFilterSheet({
  ...
  const active = countActiveLibraryFilters(filters);
        ...
        <SheetHeader className="border-b border-border bg-gradient-to-r from-card to-primary/5 px-4 py-4">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <SheetTitle className="text-base">Filtres bibliothèque</SheetTitle>
                {active > 0 && (
...
export function LibraryFilterTrigger({
  activeCount,
  onClick,
}: {
  activeCount: number;
